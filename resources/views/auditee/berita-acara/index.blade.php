    ...
    <div class="row mb-2">
      <div class="col">
        <ol class="text-sm breadcrumb float-sm-right">
          @if (request()->routeIs('auditee.berita-acara.indexRiwayat'))
            <li class="breadcrumb-item active">Daftar Riwayat Berita Acara</li>
          @elseif (request()->routeIs('auditee.berita-acara.indexBeritaAcara') || request()->routeIs('auditee.berita-acara.showBeritaAcara'))
            <li class="text-sm breadcrumb-item">
              <a href="{{ route('auditee.berita-acara.indexRiwayat') }}">
                Daftar Riwayat Berita Acara
              </a>
            </li>
          @endif
          @if (request()->routeIs('auditee.berita-acara.indexBeritaAcara'))
            <li class="breadcrumb-item active">Daftar Berita Acara</li>
          @elseif (request()->routeIs('auditee.berita-acara.showBeritaAcara'))
            <li class="text-sm breadcrumb-item">
              <a href="{{ route('auditee.berita-acara.indexBeritaAcara', [$riwayatAudit->id]) }}">
                Daftar Berita Acara
              </a>
            </li>
          @endif
          @if (request()->routeIs('auditee.berita-acara.showBeritaAcara'))
...
@section('main-content')
  <div class="container-fluid">
    <div class="row">
      <section class="col">
        ...
        <div class="card" id="riwayat-berita-acara">
          ...
          <div class="card-body">
            @if (request()->routeIs('auditee.berita-acara.show') && session()->has('status') && session()->has('message'))
                ...
                <tr>
                  ...
                  <td class="text-right d-flex justify-content-center align-items-center flex-wrap"
                    ...
                    <a class="btn btn-primary btn-xs text-nowrap"
                       href="{{ route('auditee.berita-acara.indexBeritaAcara', [$item->id]) }}#berita-acaras">
    ...
    @if (request()->routeIs('auditee.berita-acara.indexBeritaAcara') || request()->routeIs('auditee.berita-acara.showBeritaAcara'))
      <div class="row">
        <section class="col">
          <!-- Default box -->
          <div class="card" id="berita-acaras">
            ...
            <div class="card-body">
              ...
              <div class="d-flex flex-row justify-content-between">
                ...
                <div class="mb-4">
                  <a href="{{ route('auditee.berita-acara.pdf', [$riwayatAudit->id]) }}"
                ...
                @foreach ($ptks as $item)
                  <tr>
                    ...
                    <td class="text-right d-flex justify-content-center align-items-center flex-wrap"
                        style="gap: 0.5rem">
                      <a class="btn btn-primary btn-xs text-nowrap"
                         href="{{ route('auditee.berita-acara.showBeritaAcara', [$riwayatAudit->id, $item->id]) }}#detail-berita-acara">
                        <i class="mr-2 fas fa-eye"></i>Show
                      </a>
                    </td>
                  </tr>
