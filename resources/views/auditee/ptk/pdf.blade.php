      ...
      <div>
        ...
        <section class="content" style="margin-top: 1rem">
          ...
          <table style="margin-top:.3rem;width:100%;">
            <tbody>
            <tr>
              <td style="text-align:center;font-weight:bold">Tanda Tangan Auditor</td>
              <td style="text-align:center;font-weight:bold">Tanda Tangan Auditee</td>
            </tr>
            <tr>
      ...
      <div>
        <div>
          <table style="width:100%;border:none;">
            ...
            <tr>
              <td style="border:none;">
                <img src="{!! $logoIttp !!}" width="75px" alt="">
              </td>
              <td style="border:none;">
                <div style="display:inline-block;text-align: center;">
                  <h2 style="font-family: 'Arial Black';margin:0;font-size:1rem">
