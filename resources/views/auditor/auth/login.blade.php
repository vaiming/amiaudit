...
@section('content')
  <div class="col">
    <div class="card card-outline card-red">
      ...
      <div class="card-body">
        <form action="{{ route('auditor.login.check') }}" method="post" autocomplete="off">
          @csrf
          @if($errors->any())
