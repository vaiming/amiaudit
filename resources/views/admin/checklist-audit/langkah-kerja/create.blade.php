	...
	<div class="container-fluid">
		<div class="row">
			<section class="col-xl-6 col-md-8 col-sm-10 col-12">
				<form action="{{ route('admin.checklist-audit.langkah-kerja.store', [$unitKerja->id, $riwayatAudit->id, $checklistAudit->id]) }}" method="POST">
					@csrf
					@if($errors->any())
					...
					<div class="form-group" id="langkah_kerja_form">
						<label class="col-form-label" for="number_langkah_kerja">
              Langkah Kerja <br>
              <small class="text-muted">Masukkan angka yang menunjukkan jumlah dari langkah kerja yang ingin ditambahkan</small>
            </label>
						<div class="input-group mb-3">
							...
							<div class="input-group-append">
								<input type="button" value="Tambah" id="number_langkah_kerja_btn"
