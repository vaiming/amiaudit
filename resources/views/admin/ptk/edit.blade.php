		...
		<div class="row mb-2">
			<div class="col">
              ...
              Daftar Riwayat Rencana Audit - {{ $unitKerja->nama }}
					...
					<li class="text-sm breadcrumb-item">
						<a href="{{ route('admin.ptk.show', [$unitKerja->id, $riwayatAudit->id, $checklistAudit->id, $ptk->id]) }}">
							Detail PTK/OAI
						</a>
					</li>
	...
	<div class="container-fluid">
		<div class="row">
			<section class="col-xl-6 col-md-8 col-sm-10 col-12">
				<form action="{{ route('admin.ptk.update', [$unitKerja->id, $riwayatAudit->id, $checklistAudit->id, $ptk->id]) }}"
				      method="POST">
					@csrf
					@method('PUT')
					...
					<div class="d-flex justify-content-end align-items-center" style="gap: 1rem">
						<a href="{{ route('admin.ptk.show', [$unitKerja->id, $riwayatAudit->id, $checklistAudit->id, $ptk->id]) }}#detail-ptk"
