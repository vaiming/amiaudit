		...
		<div class="row mb-2">
			<div class="col">
				<ol class="text-sm breadcrumb float-sm-right">
					@if (request()->routeIs('admin.berita-acara.indexUnitKerja'))
						<li class="breadcrumb-item active">{{__('Beranda')}}</li>
					@elseif (request()->routeIs('admin.berita-acara.indexRiwayat') || request()->routeIs('admin.berita-acara.indexBeritaAcara') || request()->routeIs('admin.berita-acara.showBeritaAcara'))
					...
					@endif
					@if (request()->routeIs('admin.berita-acara.indexRiwayat'))
						<li class="breadcrumb-item active">Daftar Riwayat Berita Acara - {{ $unitKerja->nama }}</li>
					@elseif (request()->routeIs('admin.berita-acara.indexBeritaAcara') || request()->routeIs('admin.berita-acara.showBeritaAcara'))
						<li class="text-sm breadcrumb-item">
							<a href="{{ route('admin.berita-acara.indexRiwayat', [$unitKerja->id]) }}">
								Daftar Riwayat Berita Acara - {{ $unitKerja->nama }}
							</a>
						</li>
					@endif
					@if (request()->routeIs('admin.berita-acara.indexBeritaAcara'))
						<li class="breadcrumb-item active">Daftar Berita Acara</li>
					@elseif (request()->routeIs('admin.berita-acara.showBeritaAcara'))
						<li class="text-sm breadcrumb-item">
							<a href="{{ route('admin.berita-acara.indexBeritaAcara', [$unitKerja->id, $riwayatAudit->id]) }}">
								Daftar Berita Acara
							</a>
						</li>
					@endif
					@if (request()->routeIs('admin.berita-acara.showBeritaAcara'))
...
@section('main-content')
	<div class="container-fluid">
			...
			<section class="col" id="unit-kerja">
				<div class="card">
					<div class="card-header d-flex align-items-center justify-content-between">
						<h3 class="card-title flex-grow-1">Daftar Unit Kerja</h3>
					...
					<div class="card-body">
						@if (request()->routeIs('admin.berita-acara.indexUnitKerja') && session()->has('status') && session()->has('message'))
								...
								<tr>
									...
									<td class="text-right d-flex justify-content-center align-items-center flex-wrap" style="gap: 0.5rem">
										<a class="btn btn-primary btn-xs text-nowrap"
										   href="{{ route('admin.berita-acara.indexRiwayat', [$item->id]) }}#riwayat-berita-acara">
		...
		@if (request()->routeIs('admin.berita-acara.indexRiwayat') || request()->routeIs('admin.berita-acara.indexBeritaAcara') || request()->routeIs('admin.berita-acara.showBeritaAcara'))
			<div class="row">
				<section class="col">
					<!-- Default box -->
					<div class="card" id="riwayat-berita-acara">
						<div class="card-header d-flex align-items-center justify-content-between">
							<h3 class="card-title flex-grow-1">Daftar Riwayat Berita Acara</h3>
						...
						<div class="card-body">
							@if (request()->routeIs('admin.berita-acara.show') && session()->has('status') && session()->has('message'))
								<div class="alert alert-{{session()->get('status')}} alert-dismissible fade show" role="alert">
									<span>{!!session()->get('message')!!}</span>
									<button type="button" class="close" data-dismiss="alert" aria-label="Close">
										<span aria-hidden="true">&times;</span>
								...
								@foreach ($riwayatAudits as $item)
									<tr>
										...
										<td class="text-right d-flex justify-content-center align-items-center flex-wrap"
										    style="gap: 0.5rem">
											<a class="btn btn-primary btn-xs text-nowrap"
											   href="{{ route('admin.berita-acara.indexBeritaAcara', [$unitKerja->id, $item->id]) }}#berita-acaras">
												<i class="mr-2 fas fa-eye"></i>Show
											</a>
										</td>
									</tr>
		...
		@if (request()->routeIs('admin.berita-acara.indexBeritaAcara') || request()->routeIs('admin.berita-acara.showBeritaAcara'))
			<div class="row">
				<section class="col">
					<!-- Default box -->
					<div class="card" id="berita-acaras">
						<div class="card-header d-flex align-items-center justify-content-between">
							<h3 class="card-title flex-grow-1">Daftar Berita Acara</h3>
                      ...
                      <td>
                        ...
                        <span class="ml-4">
	                        {{ ' : ' . $riwayatAudit->ptks->where('type', 'OAI')->count() }}
								...
								<div class="mb-4">
									<a href="{{ route('admin.berita-acara.pdf', [$unitKerja->id, $riwayatAudit->id]) }}"
								...
								@foreach ($ptks as $item)
									<tr>
										...
										<td class="text-right d-flex justify-content-center align-items-center flex-wrap"
										    style="gap: 0.5rem">
											<a class="btn btn-primary btn-xs text-nowrap"
											   href="{{ route('admin.berita-acara.showBeritaAcara', [$unitKerja->id, $riwayatAudit->id, $item->id]) }}#detail-berita-acara">
												<i class="mr-2 fas fa-eye"></i>Show
											</a>
										</td>
									</tr>
